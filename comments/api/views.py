...
class CommentViewSet(viewsets.GenericViewSet):
    ...
    # POST /api/comments/ -> create(方法)
    # GET /api/comments/?tweet_id=1 -> list(方法)
    # GET /api/comments/1/ -> retrieve(方法)
    # DELETE /api/comments/1/ -> destroy(方法)
    # PATCH /api/comments/1/ -> partial_update(方法)
    # PUT /api/comments/1/ -> update(方法)
